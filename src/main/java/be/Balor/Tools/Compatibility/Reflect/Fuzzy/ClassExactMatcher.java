...
class ClassExactMatcher extends AbstractFuzzyMatcher<Class<?>> {
	...
	enum Options {
		...
		/**
		 * A match if the input class is a superclass of the matcher class, or
		 * the same class.
		 */
		MATCH_SUPER,

		/**
		 * A match if the input class is a derived class of the matcher class,
		 * or the same class.
		 */
		MATCH_DERIVED
	}
	 ...
	 * 
	 * @param matcher
	 *            - the matching class, or NULL to represent anything.
	 * @param option
	 *            - options specifying the matching rules.
	 */
	 ...
	 * 
	 * @param input
	 *            - the input class defined in the source file.
	 * @param parent
	 *            - the container that holds a reference to this class.
