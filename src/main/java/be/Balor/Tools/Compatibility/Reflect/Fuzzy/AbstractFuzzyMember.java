...
public abstract class AbstractFuzzyMember<T extends Member> extends AbstractFuzzyMatcher<T> {
	...
	public static abstract class Builder<T extends AbstractFuzzyMember<?>> {
		...
		/**
		 * Add a given bit-field of required modifiers for every matching
		 * member.
		 * 
		 * @param modifier
		 *            - bit-field of modifiers that are required.
		 ...
		 * 
		 * @param modifier
		 *            - bit-field of modifiers to skip or ignore.
		 * @return This builder, for chaining.
		 */
		 ...
		 * 
		 * @param regex
		 *            - new regular expression of valid names.
		 * @return This builder, for chaining.
		 */
		...
		/**
		 * Set the exact name of the member we are matching. <p< This will
		 * overwrite the regular expression rule.
		 * 
		 * @param name
		 *            - exact name.
		 * @return This builder, for chaining.
		 ...
		 *            - the declaring class of any matching member.
		 * @return This builder, for chaining.
		 */
		...
		/**
		 * Require that a member is defined by a class that matches the given
		 * matcher.
		 * 
		 * @param classMatcher
		 *            - class matcher.
		 ...
		 * <p>
		 * Builders should call {@link AbstractFuzzyMember#prepareBuild()} when
	...
	/**
	 * Retrieve a bit field of every {@link java.lang.reflect.Modifier Modifier}
	...
	/**
	 * Retrieve the regular expression pattern that is used to match the name of
	 * a member.
	 * 
