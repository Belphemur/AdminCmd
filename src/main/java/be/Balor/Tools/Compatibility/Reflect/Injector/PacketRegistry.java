...
public class PacketRegistry {
	 ...
	 *             If we're unable to retrieve the server packet data from
	 *             Minecraft.
	 */
	 ...
	 * @throws FieldAccessException
	 *             If we're unable to retrieve the client packet data from
	 *             Minecraft.
	 */
	 ...
	 *            - the packet ID.
	 * @param forceVanilla
	 *            - whether or not to look for vanilla classes, not injected
	 *            classes.
	 * @return The associated class.
	 */
